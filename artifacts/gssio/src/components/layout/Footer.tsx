  ...
  return (
    <footer className="bg-primary text-primary-foreground pt-20 pb-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <Link href="/" className="flex items-center gap-2">
              <div className="w-10 h-10 bg-white text-primary flex items-center justify-center rounded-sm font-bold text-xl tracking-tighter">
                GS
              </div>
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-secondary transition-colors" aria-label="LinkedIn">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link href="/who-we-are" className="text-primary-foreground/80 hover:text-white transition-colors">Who We Are</Link></li>
              <li><Link href="/what-we-do" className="text-primary-foreground/80 hover:text-white transition-colors">What We Do</Link></li>
              <li><Link href="/impact-reports" className="text-primary-foreground/80 hover:text-white transition-colors">Impact & Reports</Link></li>
              <li><Link href="/stories" className="text-primary-foreground/80 hover:text-white transition-colors">Stories from the Field</Link></li>
              <li><Link href="/get-involved" className="text-primary-foreground/80 hover:text-white transition-colors">Get Involved</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form className="flex flex-col gap-3" onSubmit={(e) => e.preventDefault()}>
              <input 
                ...
                className="bg-white/10 border border-white/20 text-white placeholder:text-white/50 px-4 py-3 rounded-sm focus:outline-none focus:ring-2 focus:ring-secondary"
                required
              />
              <button 
                type="submit"
                className="bg-secondary hover:bg-secondary/90 text-white font-medium py-3 rounded-sm transition-colors"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="pt-8 border-t border-white/20 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-primary-foreground/60">
