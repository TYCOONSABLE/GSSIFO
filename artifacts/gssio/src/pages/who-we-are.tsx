    ...
    <div className="py-24">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <p className="text-xl text-muted-foreground leading-relaxed mb-12">
          The Global Sustainability and Social Impact Organisation (GSSIO) was founded in 1995 with a singular vision: to address the world's most pressing challenges through coordinated, science-based, and community-led interventions.
        </p>
